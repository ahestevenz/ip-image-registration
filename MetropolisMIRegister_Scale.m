...
tic
[ movingMIReg, P, mi, th_vec, tx_vec, ty_vec,sx_vec, sy_vec, MI_vec, th_vec_a, tx_vec_a, ty_vec_a, sx_vec_a, sy_vec_a, MI_vec_a, MI_vec_derivative_a,MI_vec_accum_mean_a,MI_vec_accum_derivative_mean_a, iterations] = getMetropolisMIRegistration(fixed_8bit, moving_8bit, 250);
